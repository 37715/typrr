  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-6">
        <p className="text-base md:text-lg text-zinc-300 max-w-3xl mx-auto leading-relaxed lowercase">
          help keep typrr fast, clean, and ad-free forever
        </p>
        <p className="text-sm text-zinc-500 max-w-2xl mx-auto leading-relaxed lowercase mt-2">
      ...
      <div className="flex justify-center mb-8">
        <button
          ...
          className="group relative bg-white text-black px-10 py-3 rounded-xl font-medium text-base lowercase hover:bg-zinc-100 transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg overflow-hidden"
        >
          {/* Animated background gradient */}
          <div className="absolute inset-0 bg-gradient-to-r from-pink-500/20 via-red-500/20 to-pink-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
      ...
      <div className="text-center max-w-2xl">
        ...
        <p className="text-zinc-600 mt-1 text-xs lowercase">
      ...
      <div className="mt-8 text-center">
        <div className="inline-flex items-center gap-3 bg-zinc-900/60 backdrop-blur-md rounded-xl px-6 py-4 border border-zinc-700/50 hover:border-zinc-600/50 transition-all duration-300 group">
          ...
          <div className="text-left">
            <p className="text-sm font-medium text-white lowercase">join our community</p>
            <p className="text-xs text-zinc-400 lowercase">chat, share tips, and connect with other typers</p>
          </div>
          <a 
            href="https://discord.gg/ycKUZAES5h" 
            target="_blank" 
            rel="noopener noreferrer"
            className="ml-2 bg-indigo-500/20 hover:bg-indigo-500/30 text-indigo-400 hover:text-indigo-300 px-4 py-2 rounded-lg text-sm font-medium lowercase transition-all duration-200 hover:scale-105 active:scale-95"
          >
            join discord
          </a>
        </div>
