...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent 
        className="settings-modal-v2-forced w-[1080px] max-w-[92vw] h-[720px] max-h-[87vh] mx-auto bg-white/95 dark:bg-zinc-900/95 backdrop-blur-md border border-zinc-200 dark:border-zinc-700 p-0 overflow-hidden rounded-2xl shadow-2xl"
        style={{ 
          width: '1080px', 
          maxWidth: '92vw', 
          height: '720px', 
